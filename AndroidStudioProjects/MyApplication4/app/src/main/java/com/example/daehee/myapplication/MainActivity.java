...
import java.util.ArrayList;
 ...
 /* 출처: http://sharp57dev.tistory.com/25 */
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 액션바에 추가될 탭 생성
        ActionBar.Tab tab1 = bar.newTab().setText("친구").setTabListener(tabListener);
        ActionBar.Tab tab2 = bar.newTab().setText("대화방").setTabListener(tabListener);
        ActionBar.Tab tab3 = bar.newTab().setText("기사").setTabListener(tabListener);
        ActionBar.Tab tab4 = bar.newTab().setText("기타").setTabListener(tabListener);
